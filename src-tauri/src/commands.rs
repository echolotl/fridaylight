...
// Command to get terminal logs for a specific mod (no-op when feature disabled)
#[cfg(not(feature = "terminal-output"))]
#[tauri::command]
pub fn get_mod_logs(_id: String) -> Vec<String> {
    Vec::new()
}
...
// Command to clear terminal logs for a specific mod (no-op when feature disabled)
#[cfg(not(feature = "terminal-output"))]
#[tauri::command]
pub fn clear_mod_logs(_id: String) -> Result<(), String> {
    Ok(())
}
