<template>
    <q-scroll-area class="home-page phantom-font">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 318 32" class="gb-logo">
      <defs>
  ...
  <g shape-rendering="crispEdges">
    <g class="gb-logo2">
      ...
      <path d="M62,3h-28v26h6v-10h18v10h6V3h-2ZM58,10v3h-18v-4h18v1Z" />
      ...
      <path d="M191,3h-28v26h6v-10h18v10h6V3h-2ZM187,10v3h-18v-4h18v1Z" />
      ...
      <path d="M252,3h-28v26h6v-10h18v10h6V3h-2ZM248,10v3h-18v-4h18v1Z" />
      ...
      <path d="M314,3h-29v26h6v-10h18v10h6V3h-1ZM309,10v3h-18v-4h18v1Z" />
      <path d="M160,13V3h-27v26h29V13h-2ZM156,20v3h-17v-4h17v1ZM139,12v-3h15v4h-15v-1Z" />
    </g>
  
  <g class="gb-logo1">
    <polygon points="153 9 152 9 151 9 150 9 149 9 148 9 147 9 146 9 145 9 144 9 143 9 142 9 141 9 140 9 139 9 139 10 139 11 139 12 139 13 140 13 141 13 142 13 143 13 144 13 145 13 146 13 147 13 148 13 149 13 150 13 151 13 152 13 153 13 154 13 154 12 154 11 154 10 154 9 153 9" />
    ...
    <polygon points="247 9 246 9 245 9 244 9 243 9 242 9 241 9 240 9 239 9 238 9 237 9 236 9 235 9 234 9 233 9 232 9 231 9 230 9 230 10 230 11 230 12 230 13 231 13 232 13 233 13 234 13 235 13 236 13 237 13 238 13 239 13 240 13 241 13 242 13 243 13 244 13 245 13 246 13 247 13 248 13 248 12 248 11 248 10 248 9 247 9" />
    ...
    </div><span>Best of Today</span></h6>            <q-btn
                flat
                dense
                icon="open_in_new"
                class="phantom-font"
                label="Open Gamebanana"
                @click="openGamebanana"
            </q-btn>
        </div>        
        <div class="featured-mods-section">
          <div class="mod-card-container">            <ModCard
        ...
        <div class="main-content">        <div class="hop-back-in">
            ...
            <div class="mod-card-container">
                ...
                <InstalledModCard
                    ...
                    @showDetails="selectMod"
                />
            </div>
        </div><div class="all-mods">
            <h6 class="phantom-font-difficulty">All Mods<hr/></h6>
            <div class="mod-card-container">
                <div v-if="isLoadingInstalled" class="loading-state">
                    <q-spinner color="primary" size="2rem" />
...
const emit = defineEmits(["select-mod", "launch-mod", "open-mod-settings", "gamebanana-browser"]);
...
const downloadMod = async (mod: GameBananaMod) => {
  try {
    await gamebananaService.downloadMod(mod);
    // The gamebananaService handles the UI for download progress
  } catch (error) {
...
.best-of-today {
    ...
    background: linear-gradient(to bottom, var(--theme-card) 0%, transparent 100%);
