...
:deep(.theme-input .q-field__native),
:deep(.theme-input .q-field__prefix),
:deep(.theme-input .q-field__suffix),
:deep(.theme-input .q-field__input) {
  color: var(--theme-text);
}

:deep(.theme-input .q-field__marginal) {
  color: var(--theme-text-secondary);
}

:deep(.theme-input .q-field__label) {
  color: var(--theme-text-secondary);
}

:deep(.theme-input input::placeholder) {
  color: var(--theme-text-secondary);
}
</style>
